			...
			<div class="panel-body">
				...
				<div class="form-group col-md-6">
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" name="title" data-validate="required" data-message-required="required" placeholder="Title" />
					</div>
					 ...
					 <div class="form-group col-md-6">
						...
						<input type="text" name="tags" class="form-control tag-input-basic" data-validate="required" data-message-required="required"/>
					</div>
				     ...
				     <div class="form-group">
						...
						<textarea cols="80" id="editor4" name="description" data-validate="required" data-message-required="Meta Title is required"  rows="2" required></textarea>
					</div>
					...
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control datepicker" data-format="yyyy-mm-dd" name="log_date_created" data-validate="" data-message-required="Date is required">
					</div>
