       ...
       <link rel="stylesheet" href="https://demo.neontheme.com/assets/js/datatables/datatables.css" id="style-resource-1">
		...
		<table class="table table-bordered table-striped datatable" id="table-2">
			...
			<tbody>
				...
				@if($email_settingsdata->count()>0)
				 @foreach($email_settingsdata as $data)
				...
				<tr>
					...
					<td>
						...
						<a href="{{URL::to('edit-emailsettings',base64_encode($data->id))}}" class="btn btn-default btn-sm btn-icon icon-left">
