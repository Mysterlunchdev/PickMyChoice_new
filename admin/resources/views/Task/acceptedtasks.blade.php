@include('layouts.header')
		...
		<table class="table table-bordered table-striped datatable" id="table-2">
			...
			<tbody>
				...
				@if($acceptedtasksdata->count()>0)
				 @foreach($acceptedtasksdata as $data)
				...
				<tr>
					...
					<td>
						...
						<a href="{{URL::to('edit-acceptedtasks',base64_encode($data->id))}}" class="btn btn-info btn-sm btn-icon icon-left">
