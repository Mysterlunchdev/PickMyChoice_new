@include('layouts.header')
		...
		<table class="table table-bordered table-striped datatable" id="table-2">
			...
			<tbody>
				...
				@if($inprocesstasksdata->count()>0)
				 @foreach($inprocesstasksdata as $data)
				...
				<tr>
					...
					<td>
						...
						<a href="{{URL::to('edit-inprocesstasks',base64_encode($data->id))}}" class="btn btn-info btn-sm btn-icon icon-left">
