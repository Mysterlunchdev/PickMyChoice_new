...
<div class="vp_details">
<label>Jobcard
<span><img src="../uploads/vendor/<?php echo $getjobcarddet[0]['attachment']; ?>" style="height:50px;width:50px;" ></span></label>
</div>
</div>
...
<div class="vp_details">
<label>Certificate
<span><img src="../uploads/vendor/<?php echo $getcertificatdet[0]['attachment']; ?>" style="height:50px;width:50px;" ></span></label>
</div>
</div>
...
<span><img src="../uploads/vendor/<?php echo $getresidenproof[0]['attachment']; ?>" style="height:50px;width:50px;" ></span></label>
</div>
</div>
