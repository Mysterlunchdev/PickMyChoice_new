...
<div class="col-md-9" id="myaccoutview">
<div class="ma-right">
<div class="view-profile">
<div class="row">
<div class="col-xl-4 col-sm-6  col-lg-6 col-md-6">
<div class="vp_info">
<div class="vp_icon">
...
<div class="vp_details">
<label>Post Code
<span><?php echo trim($getuserinfo[0]['postcode']); ?></span></label>
</div>
</div>
...
<div class="vp_details">
<label>Address
<span><?php echo trim($getuserinfo[0]['address']); ?></span></label>
</div>
</div>


</div>
<div class="col-xl-4 col-sm-6  col-lg-6 col-md-66">
...
<div class="vp_details">
<label>City
<span><?php echo trim($getuserinfo[0]['city']); ?></span></label>
</div>
</div>
...
<div class="vp_details">
<label>County
<span><?php echo trim($getuserinfo[0]['street']); ?></span></label>
</div>
</div>
...
?>
<h4 class="section_sub_title">Expertise Details</h4>
<div class="row">
...
<div class="col-xl-4  col-sm-6 col-lg-6 col-md-64">

<div class="vp_info">
<div class="vp_icon">
<i class="flaticon-pass"></i>
</div>
<div class="vp_details">
<label>Ni Number
...
<h4 class="section_sub_title">Bank Details</h4>
...
<div class="col-md-9" id="myaccountedit" style="display:none">
								<div class="ma-right">
									<div class="view-profile">
										...
										<div class="row">
											<div class="col-xl-4 col-sm-6  col-lg-6 col-md-6">
												<div class="vp_info">
													...
													<div class="vp_details">
														<label>Fisrt Name <span><input type="text" id="txtepfirstname" name="txtepfirstname" value="<?php echo $getuserinfo[0]['name']; ?>" required="true" readonly></span> </div>
													</label>
												</div>
											</div>
											<div class="col-xl-4 col-sm-6  col-lg-6 col-md-6">
												<div class="vp_info">
													...
													<div class="vp_details">
														<label>last Name <span><input type="text" value="<?php echo $getuserinfo[0]['last_name']; ?>" required="true" id="txteplastname" name="txteplastname" readonly> </span></label>
													</div>
												</div>
											</div>
											<div class="col-xl-4  col-sm-6 col-lg-6 col-md-6">
												<div class="vp_info">
													...
													<div class="vp_details">
														<label>Date of Birth <span><input type="text" value="<?php echo $getuserinfo[0]['dob'];?>" required="true" id="txtepdob" name="txtepdob" readonly></span></label>
													</div>
												</div>
											</div>
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													...
													<div class="vp_details">
														...
														<select id="selepgender" name="selepgender" class="form-control" readonly>
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													...
													<div class="vp_details">
														<label>Address <span><input type="text" value="<?php echo trim($getuserinfo[0]['address']); ?>" id="txtepaddrs" name="txtepaddrs" required="true" ></span></label>
													</div>
												</div>
											</div>
												<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-location"></i> </div>
													<div class="vp_details">
														<label>City <span><input type="text" value=" <?php echo trim($getuserinfo[0]['city']); ?>" id="txtepcity" name="txtepcity" required="true" ></span></label>
													</div>
												</div>
											</div>
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													...
													<div class="vp_details">
														<label>County <span><input type="text" value="<?php echo trim($getuserinfo[0]['street']); ?>" id="txteplandmark" name="txteplandmark" ></span></label>
													</div>
												</div>
											</div>
...
?>
	...
	//$exploadcertificate=explode(".",$expcertificate);
										...
										<div class="row">
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-admin"></i> </div>
													<div class="vp_details">
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-category"></i> </div>
													<div class="vp_details">
...
<select class="selectpicker" id="selsubcat" name="selsubcat">
		...
		?>
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-experience"></i> </div>
													<div class="vp_details">
														<label>Exeperience <span><input type="text" value="<?php echo $getuserexpinfo[0]['expert_in_yrs'];?>" required="true" id="txtepwrkexp" name="txtepwrkexp" onkeypress="return isNumber(event)" onblur="getExperience(this.value)"></span></label>
														<span id="txtexp" style="color:red"></span>
													</div>
												</div>
											</div>
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-pass"></i> </div>
													<div class="vp_details">
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-worker"></i> </div>
													<div class="vp_details">
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-insurance"></i> </div>
													<div class="vp_details">
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-driving-license"></i> </div>
														<div class="vp_details">
													<label>Driving License Status <span>
<label class="chkcontainer">
																<input type="radio" name="epradiomotorstslicen" value="yes" <?php if($getuserexpinfo[0]['motor_licence_status']=='yes'){ echo "checked"; } ?> >Yes <span class="chkcheckmark"></span> </label>
															
															<label class="chkcontainer">
																<input type="radio" name="epradiomotorstslicen" value="no" <?php if($getuserexpinfo[0]['motor_licence_status']=='no'){ echo "checked"; } ?>>No <span class="chkcheckmark"></span> </label>
													</span></label>
													</div>
												</div>
											</div>
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-car-insurance"></i> </div>
													<div class="vp_details">
												...
												<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-id-card"></i> </div>
													<div class="vp_details">
													    <div class="row">
													        ...
													        <div class="col-xl-5 col-md-6 align-items-end ">
													            	<span>
													<?php
													if(strpos($expgetjobcrd, '.pdf') !== false)
													{
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-certificate"></i> </div>
													<div class="vp_details">
											...
											<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-architect"></i> </div>
													<div class="vp_details">
													    		    <div class="row align-items-center">
													      <div class="col-xl-7 col-md-8">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-bank"></i> </div>
													<div class="vp_details">
											...
											<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
												<div class="vp_info">
													<div class="vp_icon"> <i class="flaticon-bank-1"></i> </div>
													<div class="vp_details">
									...
									<button class="btn-evp" type="button" onClick="showEditDive('view')" style="margin-right:8px;"><i class="fa fa-eye"></i>View Details</button>
								</div>
	...
	function issNumber(evt) 
	{
	   ...
	   if(parseInt(val)>=1 && parseInt(val)<=50){
	       document.getElementById("txtexp").innerHTML="";
		        ...
		        document.getElementById("txtepwrkexp").value="";
		        }
                            	}
		
		$("#txtepwrkexp").keyup(function(){
		ka = $(this);
		if(ka.val().length >= 2){
